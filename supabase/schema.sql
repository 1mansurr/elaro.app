...
-- Update handle_new_user function with proper search_path and logging
-- This approach doesn't require dropping the trigger (which needs superuser permissions)
...
DO $$
BEGIN
  RAISE NOTICE 'Function handle_new_user updated successfully with search_path';
END $$;
