-- Update create_course_and_lectures_transaction function to include venue parameter
...
BEGIN
    ...
    IF p_recurrence_type = 'none' THEN
        ...
        INSERT INTO public.lectures (user_id, course_id, lecture_name, start_time, end_time, venue)
        VALUES (p_user_id, new_course_id, p_course_name, p_start_time, p_end_time, p_venue)
    ...
    ELSE
        ...
        FOR i IN 0..15 LOOP
            ...
            INSERT INTO public.lectures (user_id, course_id, lecture_name, start_time, end_time, venue)
            VALUES (p_user_id, new_course_id, p_course_name, current_lecture_start, current_lecture_end, p_venue)
            RETURNING id INTO new_lecture_id;
