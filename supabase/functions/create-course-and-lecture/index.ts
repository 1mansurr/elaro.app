...
async function handleCreateCourseAndLecture(req: AuthenticatedRequest) {
...
serve(
  createAuthenticatedHandler(handleCreateCourseAndLecture, {
    rateLimitName: 'create-course-and-lecture',
