...
with_node \
  ...
  --target "/Users/new/Desktop/Biz/ELARO/ELARO-app/ios/Pods/Target Support Files/Pods-Elaro/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-apple-authentication" "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-clipboard" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-updates" "expo-web-browser"
