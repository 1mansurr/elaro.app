...
struct [[deprecated("Use RNSentryNativeAppStartResponseBridging instead.")]] RNSentryBaseNativeAppStartResponseBridging {
  static RNSentryBaseNativeAppStartResponse<P0, P1, P2, P3> fromJs(
      jsi::Runtime &rt,
      const jsi::Object &value,
      const std::shared_ptr<CallInvoker> &jsInvoker) {
    RNSentryBaseNativeAppStartResponse<P0, P1, P2, P3> result{
      bridging::fromJs<P0>(rt, value.getProperty(rt, "type"), jsInvoker),
      bridging::fromJs<P1>(rt, value.getProperty(rt, "has_fetched"), jsInvoker),
      bridging::fromJs<P2>(rt, value.getProperty(rt, "app_start_timestamp_ms"), jsInvoker),
      bridging::fromJs<P3>(rt, value.getProperty(rt, "spans"), jsInvoker)};
    return result;
  }

#ifdef DEBUG
  static jsi::String typeToJs(jsi::Runtime &rt, P0 value) {
    return bridging::toJs(rt, value);
  }

  static bool has_fetchedToJs(jsi::Runtime &rt, P1 value) {
    return bridging::toJs(rt, value);
  }

  static double app_start_timestamp_msToJs(jsi::Runtime &rt, P2 value) {
    return bridging::toJs(rt, value);
  }

  static jsi::Array spansToJs(jsi::Runtime &rt, P3 value) {
    return bridging::toJs(rt, value);
  }
#endif
  ...
  static jsi::Object toJs(
      jsi::Runtime &rt,
      const RNSentryBaseNativeAppStartResponse<P0, P1, P2, P3> &value,
      const std::shared_ptr<CallInvoker> &jsInvoker) {
    auto result = facebook::jsi::Object(rt);
...
public:
  ...
  virtual jsi::Value fetchNativeLogAttributes(jsi::Runtime &rt) = 0;
