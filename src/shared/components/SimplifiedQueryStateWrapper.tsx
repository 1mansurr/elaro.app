...
interface QueryStateConfig<T = unknown> {
  isLoading: boolean;
  isError: boolean;
  error: Error | null;
...
interface SimplifiedQueryStateWrapperProps<T = unknown> {
  queryState: QueryStateConfig<T>;
...
export const SimplifiedQueryStateWrapper = <T = unknown,>({
  queryState,
  emptyState,
  loadingState,
  onRefresh,
  children,
}: SimplifiedQueryStateWrapperProps<T>) => {
...
export const QueryStateWrapper = <T = unknown,>(props: {
  isLoading: boolean;
  isError: boolean;
  error: Error | null;
  data: T | null | undefined;
