...
export const TabBarIcon: React.FC<{ name: IconName; color?: IconColor | string }> = ({ 
  name, 
  color = 'textSecondary' 
}) => (
...
export const ButtonIcon: React.FC<{ 
  ...
  <Icon name={name} size={`button${size.charAt(0).toUpperCase() + size.slice(1)}` as IconPreset} color={color} />
);
...
export const ListItemIcon: React.FC<{ 
  ...
  <Icon name={name} size={`listItem${size.charAt(0).toUpperCase() + size.slice(1)}` as IconPreset} color={color} />
);
...
export const StatusIcon: React.FC<{ 
  ...
  <Icon name={name} size={`status${size.charAt(0).toUpperCase() + size.slice(1)}` as IconPreset} color={color} />
);
