  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.label}>Choose a course for your study session *</Text>
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          <Text style={[styles.courseInputText, !sessionData.course && styles.placeholderText]}>
            {isLoading 
              ? 'Loading courses...' 
              : sessionData.course?.course_name || (courses.length === 0 ? 'Please add a course first' : 'Select a course')
            }
          </Text>
                  ...
                  {courses.map(course => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        sessionData.course?.id === course.id && styles.selectedOption
                      ]}
        ...
        {sessionData.course && (
          <View style={styles.selectedCourseInfo}>
            ...
            <Text style={styles.selectedCourseName}>{sessionData.course.course_name}</Text>
            {sessionData.course.course_code && (
              <Text style={styles.selectedCourseCode}>{sessionData.course.course_code}</Text>
            )}
          </View>
        )}

        <View style={styles.tipsContainer}>
          <Text style={styles.tipsTitle}>💡 Study Session Tips:</Text>
          <Text style={styles.tipText}>
            • Choose the course you want to focus on
          </Text>
          <Text style={styles.tipText}>
            • Study sessions help you stay organized
          </Text>
          <Text style={styles.tipText}>
