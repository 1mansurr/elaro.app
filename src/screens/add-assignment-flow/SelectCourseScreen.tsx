      ...
      <View style={styles.content}>
        ...
        >
          <Text style={[styles.courseInputText, !assignmentData.course && styles.placeholderText]}>
            {isLoading 
              ? 'Loading courses...' 
              : assignmentData.course?.course_name || (courses.length === 0 ? 'Please add a course first' : 'Select a course')
            }
          </Text>
        ...
        {assignmentData.course && (
          <View style={styles.selectedCourseInfo}>
            ...
            <Text style={styles.selectedCourseName}>{assignmentData.course.course_name}</Text>
            {assignmentData.course.course_code && (
              <Text style={styles.selectedCourseCode}>{assignmentData.course.course_code}</Text>
            )}
          </View>
        )}
      </View>
