      ...
      <View style={styles.content}>
        ...
        >
          <Text style={[styles.courseInputText, !lectureData.course && styles.placeholderText]}>
            {isLoading 
              ? 'Loading courses...' 
              : lectureData.course?.course_name || (courses.length === 0 ? 'Please add a course first' : 'Select a course')
            }
          </Text>
        ...
        {lectureData.course && (
          <View style={styles.selectedCourseInfo}>
            ...
            <Text style={styles.selectedCourseName}>{lectureData.course.course_name}</Text>
            {lectureData.course.course_code && (
              <Text style={styles.selectedCourseCode}>{lectureData.course.course_code}</Text>
            )}
          </View>
        )}
      </View>
