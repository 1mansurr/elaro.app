...
const GuideSectionScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <StatusBar barStyle={theme.text === '#000000' ? 'dark-content' : 'light-content'} backgroundColor={theme.primary} />
      ...
      <View style={[styles.header, { backgroundColor: theme.primary }]}>
        ...
        <View style={styles.headerCenter}>
          <Text style={[styles.headerTitle, { color: theme.white }]}>{currentGuide.title}</Text>
          <Text style={[styles.headerSubtitle, { color: 'rgba(255,255,255,0.8)' }]}>{currentGuide.subtitle}</Text>
        </View>
