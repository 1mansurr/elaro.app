 ...
 */
export const validateTemplateData = (templateData: any, taskType: string): { isValid: boolean; error?: string } => {
 ...
 */
export const createTemplateDataFromTask = (taskData: any, taskType: 'assignment' | 'lecture' | 'study_session'): any => {
 ...
 */
export const canSaveAsTemplate = (taskData: any, taskType: 'assignment' | 'lecture' | 'study_session'): boolean => {
