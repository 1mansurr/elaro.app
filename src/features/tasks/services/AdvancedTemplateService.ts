...
export class AdvancedTemplateService {
   ...
   */
  private mapCategoryFromDB(dbCategory: any): TemplateCategory {
    return {
      id: dbCategory.id,
   ...
   */
  private mapShareFromDB(dbShare: any): TemplateShare {
    return {
      id: dbShare.id,
   ...
   */
  private mapRatingFromDB(dbRating: any): TemplateRating {
    return {
      id: dbRating.id,
   ...
   */
  private mapUsageFromDB(dbUsage: any): TemplateUsage {
    return {
      id: dbUsage.id,
