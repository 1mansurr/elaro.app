...
export class RecurringTaskService {
   ...
   */
  private mapPatternFromDB(dbPattern: any): RecurringPattern {
    return {
      id: dbPattern.id,
      name: dbPattern.name,
   ...
   */
  private mapRecurringTaskFromDB(dbTask: any): RecurringTask {
    return {
      id: dbTask.id,
   ...
   */
  private mapGeneratedTaskFromDB(dbTask: any): GeneratedTask {
    return {
      id: dbTask.id,
