...
type StudySessionReviewScreenRouteProp = RouteProp<RootStackParamList, 'StudySessionReview'>;
type StudySessionReviewScreenNavigationProp = StackNavigationProp<RootStackParamList, 'StudySessionReview'>;
...
const StudySessionReviewScreen: React.FC = () => {
    ...
    return (
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: theme.text }]}>Review Study Session</Text>
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]} testID="study-session-review-screen">
      {/* Header */}
      <View style={styles.header}>
