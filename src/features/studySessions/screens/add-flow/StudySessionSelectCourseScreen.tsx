      ...
      <View style={styles.content}>
        ...
        >
          <Text style={[styles.courseInputText, !sessionData.course && styles.placeholderText]}>
            {isLoading 
              ? 'Loading courses...' 
              : sessionData.course?.courseName || (courses.length === 0 ? 'Please add a course first' : 'Select a course')
            }
          </Text>
        ...
        {sessionData.course && (
          <View style={styles.selectedCourseInfo}>
            ...
            <Text style={styles.selectedCourseName}>{sessionData.course.courseName}</Text>
            {sessionData.course.courseCode && (
              <Text style={styles.selectedCourseCode}>{sessionData.course.courseCode}</Text>
            )}
          </View>
        )}
