      ...
      <SafeAreaView style={{ backgroundColor: theme.card }}>
        <View
          ...
          <Text
            style={[
              styles.headerTitle,
              { fontSize: SPACING.lg, color: theme.text },
            ]}>
            Help & Feedback
          </Text>
      ...
      <ScrollView
        ...
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          <Text
            style={[
              styles.heading,
              { fontSize: SPACING.xl, color: theme.text },
            ]}>
            ❓ Need help?
          </Text>
          <Text
            style={[
              styles.body,
              { fontSize: SPACING.md, color: theme.textSecondary },
            ]}>
            We&apos;re here to help you get the most out of ELARO. Here are the
        ...
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          ...
          <View style={{ flexDirection: 'column', gap: 16, marginTop: 12 }}>
            <TouchableOpacity
              onPress={() => Linking.openURL('mailto:support@myelaro.com')}
              style={supportButtonStyle(theme)}>
              <Text style={linkTextStyle(theme)}>Email Us</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.navigate('TawkChat' as never)}
              style={supportButtonStyle(theme)}>
              <Feather
                name="message-circle"
                size={18}
                ...
                style={{ marginRight: 8 }}
              />
              <Text style={linkTextStyle(theme)}>
...
• Still having trouble? Contact support for help
        ...
        <View style={styles.footer}>
          <Text
            style={[
              styles.footerText,
              { fontSize: SPACING.md, color: theme.primary },
            ]}>
            Thank you for using ELARO! 🚀
          </Text>
        </View>
      </ScrollView>
    </View>
