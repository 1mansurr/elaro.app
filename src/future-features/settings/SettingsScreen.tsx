      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            Alert.alert(
              'Account Deletion',
              'Account deletion functionality will be implemented in the next update.',
            );
          },
        },
      ],
        ...
        <Card
          ...
          <View
            ...
            <Text
              style={[
                styles.sectionTitle,
                { color: theme.text, fontWeight: fontWeightSemibold },
              ]}>
              Notifications
            </Text>
          </View>
          ...
          <View style={styles.settingRow}>
            <View style={styles.settingContent}>
              <Text
                style={[
                  styles.settingLabel,
                  { color: theme.text, fontWeight: fontWeightMedium },
                ]}>
            ...
            <View style={styles.subsection}>
              ...
              {REMINDER_OPTIONS.map(option => (
                <Pressable
                  ...
                  accessibilityState={{
                    checked: defaultReminderTimes.includes(option.value),
                  }}>
                  <View
                    style={[
                      styles.checkbox,
          ...
          <View style={styles.colorGrid}>
            {COLOR_PALETTE.map(colorOption => (
              <View key={colorOption.name} style={styles.colorItem}>
                ...
                />
                <Text
                  style={[styles.colorLabel, { color: theme.textSecondary }]}>
                  {colorOption.name}
                </Text>
              </View>
            ))}
          ...
          <Pressable
            ...
            <View style={styles.settingContent}>
              ...
              <Text
                style={[
                  styles.settingLabel,
                  { color: theme.error, fontWeight: fontWeightMedium },
                ]}>
                Sign Out
              </Text>
            </View>
          ...
          <Pressable
            ...
            <View style={styles.settingContent}>
              ...
              <Text
                style={[
                  styles.settingLabel,
                  { color: theme.warning, fontWeight: fontWeightMedium },
                ]}>
                Clear All Data
              </Text>
            </View>
