    ...
    <View style={styles.container}>
      {isSubscribed ? (
        <View
          style={[
            styles.oddityCard,
            { backgroundColor: isDark ? COLORS.gray900 : COLORS.purple50 },
          ]}>
          <View style={styles.planHeader}>
            <View style={styles.badgeContainer}>
              <Ionicons
                name="star"
                size={16}
                color={isDark ? COLORS.purple200 : COLORS.purple600}
              />
              <Text
                style={[
                  styles.planBadge,
            ...
            <Text
              style={[
                styles.planStatus,
                {
                  color: isDark ? COLORS.white : COLORS.purple600,
                  backgroundColor: isDark ? COLORS.purple800 : COLORS.purple100,
                },
              ]}>
              Active
            </Text>
          ...
          <Text
            style={[
              ...
              { color: isDark ? COLORS.gray100 : COLORS.text },
            ]}>
            You&apos;re unlocking your full potential with premium study
            planning
          </Text>
        ...
        <View style={styles.freeCard}>
          ...
          <View style={styles.featureList}>
            ...
            <Text style={[styles.featureItem, { color: COLORS.text }]}>
              • Up to {PLANS.origin.srLimit} spaced repetition reminders
            </Text>
          </View>
          <Pressable
            style={[
            ...
            <Text
              style={[
                ...
                { color: COLORS.white, fontSize: FONT_SIZES.lg },
              ]}>
              🚀 Become an Oddity
            </Text>
          </Pressable>
